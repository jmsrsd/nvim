...
_G.packer_plugins = {
  ...
  ["laravel.nvim"] = {
    loaded = true,
    path = "C:\\Users\\Jemal\\AppData\\Local\\nvim-data\\site\\pack\\packer\\start\\laravel.nvim",
